...
## [0.0.35](https://github.com/dijacky/deepagents/compare/deepagents-cli==0.0.34...deepagents-cli==0.0.35) (2026-04-03)
...
* **cli:** `/auto-update` to toggle auto-updates ([#2276](https://github.com/dijacky/deepagents/issues/2276)) ([ad70bde](https://github.com/dijacky/deepagents/commit/ad70bde070c58057ff98871fcacd95f03487051e))
...
* **cli:** add `DEEPAGENTS_CLI_` env var prefix and fix dotenv load order ([#2303](https://github.com/dijacky/deepagents/issues/2303)) ([29647bb](https://github.com/dijacky/deepagents/commit/29647bb4cdd89a1de65f6adb518f708135d59e03))
...
* **cli:** add `ls_integration` metadata to langsmith traces ([#2272](https://github.com/dijacky/deepagents/issues/2272)) ([5dd8098](https://github.com/dijacky/deepagents/commit/5dd80983a57a5c48bb9c75c6760733882cb908c2))
...
* **cli:** agent-friendly ux for scripted/headless workflows ([#2271](https://github.com/dijacky/deepagents/issues/2271)) ([386438f](https://github.com/dijacky/deepagents/commit/386438f62a458baa367468cf746c3a5387a217d4))
...
* **cli:** allow color overrides on built-in themes, default dark to false ([#2275](https://github.com/dijacky/deepagents/issues/2275)) ([8f71865](https://github.com/dijacky/deepagents/commit/8f718650ee1913f83e70aa7854e576edc816e694))
...
* **cli:** default langsmith project to `'deepagents-cli'` ([#2277](https://github.com/dijacky/deepagents/issues/2277)) ([7178b87](https://github.com/dijacky/deepagents/commit/7178b8729a03ee1e5508fdf6c111488d18e77e8f))
...
* **cli:** load `~/.deepagents/.env` as global dotenv ([#1909](https://github.com/dijacky/deepagents/issues/1909)) ([5a21d0a](https://github.com/dijacky/deepagents/commit/5a21d0add1d2a885c6cd3cf36621d1da690c8db3))
...
* **cli:** persist token count in graph state across sessions ([#2323](https://github.com/dijacky/deepagents/issues/2323)) ([5be352d](https://github.com/dijacky/deepagents/commit/5be352d8bb4d266758f3e934f7affbe8d42b0149))
...
* **cli:** render ask-user questions as markdown ([#2339](https://github.com/dijacky/deepagents/issues/2339)) ([5fbb14a](https://github.com/dijacky/deepagents/commit/5fbb14a4fd6f2800aec99add1d9f32b88c1d751a))
...
* **cli:** support root/MDM installs ([#2346](https://github.com/dijacky/deepagents/issues/2346)) ([f618acc](https://github.com/dijacky/deepagents/commit/f618acc671ca2137df165d6f56e8a46f11c63abb))
...
* **cli:** surface unsupported input modalities in system prompt ([#2327](https://github.com/dijacky/deepagents/issues/2327)) ([95620e7](https://github.com/dijacky/deepagents/commit/95620e796aa6bf11f424d2f83693026fbee6be58))
...
* **sdk,cli:** add openrouter SDK attribution ([#2205](https://github.com/dijacky/deepagents/issues/2205)) ([2798e51](https://github.com/dijacky/deepagents/commit/2798e51fd90128ffd1a2064383db17c699805395))
...
* **cli:** disable markup parsing for blocked-link notifications ([#2170](https://github.com/dijacky/deepagents/issues/2170)) ([15867bf](https://github.com/dijacky/deepagents/commit/15867bfaeb43b5fca31677fd06b25022aec10c8b))
...
* **cli:** eliminate trace fragmentation in non-interactive mode ([#2136](https://github.com/dijacky/deepagents/issues/2136)) ([9bddc52](https://github.com/dijacky/deepagents/commit/9bddc52b572672e0564bfc4a8675e106d98116af))
* **cli:** enforce approval toggle when launched with `-y` ([#2278](https://github.com/dijacky/deepagents/issues/2278)) ([28a32b7](https://github.com/dijacky/deepagents/commit/28a32b7dfb6fd6ddb9aa443a9d0d70c33790edbd))
...
* **cli:** escape exception text in rich markup error output ([#2307](https://github.com/dijacky/deepagents/issues/2307)) ([42bccca](https://github.com/dijacky/deepagents/commit/42bccca05f1733a04ee21da6bf9924140f6e1e65))
...
* **cli:** exit app on `ctrl+d` when thread list is empty ([#2270](https://github.com/dijacky/deepagents/issues/2270)) ([e859077](https://github.com/dijacky/deepagents/commit/e859077ffa7ee0423bbc7b86d5a4238798ec9c9a))
...
* **cli:** mark token count as approximate after interrupted generation ([#2353](https://github.com/dijacky/deepagents/issues/2353)) ([cb9a0c7](https://github.com/dijacky/deepagents/commit/cb9a0c7ad2f9421471b4276a33beabc30588b694))
...
* **cli:** open trace in browser immediately when busy ([#2305](https://github.com/dijacky/deepagents/issues/2305)) ([b452032](https://github.com/dijacky/deepagents/commit/b452032438f83e0cca245dcabacf176cc1aa8857))
...
* **cli:** prevent session stats loss on mid-turn exit ([#2238](https://github.com/dijacky/deepagents/issues/2238)) ([b1807aa](https://github.com/dijacky/deepagents/commit/b1807aab78175c53a2d6f835ae30171d0f802d1c))
...
* **cli:** use relative paths in langgraph config for Windows compat ([#2244](https://github.com/dijacky/deepagents/issues/2244)) ([d10dfbd](https://github.com/dijacky/deepagents/commit/d10dfbd7d8ff18653d0d25197c76c8b379f60bf0))
...
* **cli:** warn agent that local filesystem is inaccessible in sandbox mode ([#2274](https://github.com/dijacky/deepagents/issues/2274)) ([a3b61e5](https://github.com/dijacky/deepagents/commit/a3b61e5d57fcf240fec4afa7734a5c864bdcd886))
...
* **cli:** defer `/model` selector data loading off event loop ([#2259](https://github.com/dijacky/deepagents/issues/2259)) ([a32ce7f](https://github.com/dijacky/deepagents/commit/a32ce7ff6b2112cf48170d2279a1953eded61987))
...
* **cli:** defer pydantic and adapter imports out of startup hot path ([#2269](https://github.com/dijacky/deepagents/issues/2269)) ([0a410b4](https://github.com/dijacky/deepagents/commit/0a410b4aba729a71c78e7fd470c904d95fea171a))
...
* **cli:** prewarm markdown stack and cache skill body render ([#2236](https://github.com/dijacky/deepagents/issues/2236)) ([0a3ba47](https://github.com/dijacky/deepagents/commit/0a3ba47615bfdaba1a51dbff1c75c392dd87579e))
* **cli:** reduce health poll interval for local langgraph dev server ([#2283](https://github.com/dijacky/deepagents/issues/2283)) ([7f5c3de](https://github.com/dijacky/deepagents/commit/7f5c3de9cf5501abc24fbaf50152c4c625b04f1b))
