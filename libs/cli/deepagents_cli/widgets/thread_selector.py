...
class ThreadSelectorScreen(ModalScreen[str | None]):
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            session_store: Thread persistence backend (defaults to local SQLite).
        """
        super().__init__()
    ...
    async def _populate_visible_checkpoint_details(self) -> tuple[bool, bool]:
        ...
        await self._session_store.populate_thread_checkpoint_details(
            self._threads,
    ...
    async def _load_threads(self) -> None:
        ...
        try:
            ...
            self._threads = await self._session_store.list_threads(
